...
- `2026-04-04-remove-frb-hard-cut-resequenced-plan.md`：FRB hard cut 的当前执行计划，按当前代码状态重排顺序。
...
- `2026-04-02-remove-frb-and-legacy-rust-surface-implementation-plan.md`：已被新版替代，因 review 追踪仍暂留本目录。
